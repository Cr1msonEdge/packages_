...
def structHyst():
    ...
    structCountOnk = pd.DataFrame({hyst: [hystDict[x] for x in hystOnk],
                                   structDict[0]: [len(tmpDF[(tmpDF[hyst] == x) & (tmpDF[struct] == 0)]) * 100.0 / len(
                                       tmpDF[tmpDF[hyst] == x]) for x in hystOnk],
                                   structDict[1]: [len(tmpDF[(tmpDF[hyst] == x) & (tmpDF[struct] == 1)]) * 100.0 / len(
                                       tmpDF[tmpDF[hyst] == x]) for x in hystOnk],
                                   structDict[2]: [len(tmpDF[(tmpDF[hyst] == x) & (tmpDF[struct] == 2)]) * 100.0 / len(
                                       tmpDF[tmpDF[hyst] == x]) for x in hystOnk],
                                   structDict[3]: [len(tmpDF[(tmpDF[hyst] == x) & (tmpDF[struct] == 3)]) * 100.0 / len(
                                       tmpDF[tmpDF[hyst] == x]) for x in hystOnk],
                                   structDict[4]: [len(tmpDF[(tmpDF[hyst] == x) & (tmpDF[struct] == 4)]) * 100.0 / len(
                                       tmpDF[tmpDF[hyst] == x]) for x in hystOnk]})
